...
import { ITermsAndPrivacyLocale } from '@app/abstractions';
import { SupportedLocalesEnum } from '@app/enums';
const language = SupportedLocalesEnum.JAPANESE;
export const TermsAndPrivacyLocaleJapanese: ITermsAndPrivacyLocale = {
  metadata: {
    title: 'License Agreement - Game.tv',
    description: 'Game.tv License Agreement',
  },
  heading: `PLEASE NOTE THAT YOUR USE OF AND ACCESS TO OUR SERVICES (DEFINED BELOW) ARE SUBJECT TO THE FOLLOWING TERMS; IF YOU DO NOT AGREE TO ALL OF THE FOLLOWING, YOU MAY NOT USE OR ACCESS THE SERVICES IN ANY MANNER.`,
  subHeading: `Terms of Use`,
  contents: [
    {
      steps: [
        {
          content: `Effective date: September 1, 2019`,
        },
        {
          content: `Welcome to Game.TV. Please read on to learn the rules and restrictions that govern your use of our website, products, services and applications (the “Services”). If you have any questions, comments, or concerns regarding these terms or the Services, please contact us at TOU@Game.TV.`,
        },
        {
          content: `These Terms of Use (the “Terms”) are a binding contract between you and Game.TV, Inc.
          (“Game.TV,” “we” and “us”). You must agree to and accept all of the Terms, or you don’t have the right to use the Services. Your using the Services in any way means that you agree to all of these Terms, and these Terms will remain in effect while you use the Services. These Terms include the provisions in this document, as well as those in the Privacy Policy and Copyright Dispute Policy <a href="/${language}/terms-and-privacy">here.</a>`,
        },
      ],
    },
    {
      ...
      steps: [
        {
          content: `We are constantly trying to improve our Services, so these Terms may need to change along
          with the Services. We reserve the right to change the Terms at any time, but if we do, we will bring it to your attention by placing a notice on the Game.TV website, by sending you an email, and/or by some other means.`,
        },
        {
          content: `If you don’t agree with the new Terms, you are free to reject them; unfortunately, that means you will no longer be able to use the Services. If you use the Services in any way after a change to the Terms is effective, that means you agree to all of the changes.`,
        },
        {
          content: `Except for changes by us as described here, no other amendment or modification of these
    ...
    },
    {
      ...
      steps: [
        {
          content: `Game.TV takes the privacy of its users very seriously. For the current Game.TV Privacy Policy, please click <a href="/${language}/terms-and-privacy">here.</a>`,
        },
        {
          content: `The Children’s Online Privacy Protection Act (“COPPA”) requires that online service providers obtain parental consent before they knowingly collect personally identifiable information online from children who are under 13. We do not knowingly collect or solicit personally identifiable information from children under 13; if you are a child under 13, please do not attempt to register for the Services or send any personal information about yourself to us. If we learn we have collected personal information from a child under 13, we will delete that information as quickly as possible. If you believe that a child under 13 may have provided us personal information, please contact us at TOU@Game.TV.`,
        },
      ],
    },
    {
      title: `What are the basics of using Game.TV?`,
      steps: [
        {
          title: `Registration Information`,
          content: `Users must register to use the Services. In addition, you may be required to register a
          nickname, e-mail address, password, etc., or an ID and password issued by a third party designated by us, at Game.TV (hereinafter referred to as &quot;Registration Information&quot;).`,
        },
        {
          content: `You promise to provide us and/or the third party with accurate, complete, and updated
          ...
          is invalid or inappropriate, as solely determined by Game.TV, we reserve the right remove the
          Registration Information.`,
        },
        {
          content: `You represent and warrant that you are of legal age to form a binding contract (or if not, you’ve
        ...
        {
          content: `You will only use the Services for your own personal, non-commercial use, and not on behalf of or for the benefit of any third party, and only in a manner that complies with all laws that apply to you. If your use of the Services is prohibited by applicable laws, then you aren’t authorized to use the Services. We can’t and won’t be responsible for your using the Services in a way that breaks the law.`,
        },
        {
          extraContentClass: `mb-32`,
          content: `You will not share your account or password with anyone, and you must protect the security of your account and your password. You’re responsible for any activity associated with your account.`,
        },
        {
          title: `Your use of the Services is subject to the following additional restrictions:`,
          content: `You represent, warrant, and agree that you will not contribute any Content or User Submission (each of those terms is defined below) or otherwise use the Services or interact with the Services in a manner that:`,
        },
        {
          extraContentClass: `mb-24 pl-24`,
          content: `(a) Infringes or violates the intellectual property rights or any other rights of anyone else (including Game.TV);`,
        },
        {
          extraContentClass: `mb-24 pl-24`,
          content: `(b) Violates any law or regulation, including any applicable export control laws;`,
        },
        {
          extraContentClass: `mb-24 pl-24`,
          content: `(c) Is harmful, fraudulent, deceptive, threatening, harassing, defamatory, obscene, or otherwise objectionable;`,
        },
        {
          extraContentClass: `mb-24 pl-24`,
          content: `(d) Jeopardizes the security of your Game.TV account or anyone else’s (such as
            allowing someone else to log in to the Services as you);`,
        },
        {
          extraContentClass: `mb-24 pl-24`,
          content: `(e) Attempts, in any manner, to obtain the password, account, or other security
          information from any other user;`,
        },
        {
          extraContentClass: `mb-24 pl-24`,
          content: `(f) Violates the security of any computer network, or cracks any passwords or security encryption codes;`,
        },
        {
          extraContentClass: `mb-24 pl-24`,
          content: `(g) Runs Maillist, Listserv, any form of auto-responder or “spam” on the Services, or any
        ...
        {
          extraContentClass: `mb-24 pl-24`,
          content: `(h) “Crawls,” “scrapes,” or “spiders” any page, data, or portion of or relating to the
          Services or Content (through use of manual or automated means);`,
        },
        {
          extraContentClass: `mb-24 pl-24`,
          content: `(i) Copies or stores any significant portion of the Content;`,
        },
        {
          extraContentClass: `mb-24 pl-24`,
          content: `j) Decompiles, reverse engineers, or otherwise attempts to obtain the source code or
          underlying ideas or information of or relating to the Services.`,
        },
        {
          extraContentClass: `mb-24`,
          content: `A violation of any of the foregoing is grounds for termination of your right to use or access the
          Services.`,
        },
        {
          title: `About Tournaments`,
          content: `The tournaments that are held using the Game.TV platform will be organized and operated by a
          unaffiliated third-party organizers (“Organizer”) in accordance with the tournament rules in place
          for the individual tournaments. Users may participate in a tournament after confirming their
          adherence to the specific tournament rules.`,
        },
        {
          extraContentClass: `mb-24`,
          content: `The Organizers shall take any action that they consider appropriate, such as correction,
        ...
        {
          title: `About Game.TV Promotions`,
          content: `Game.TV may sponsor promotions related to the above tournaments which will be run in
          accordance with the promotion rules as published by Game.TV.`,
          extraContentClass: `mb-24`,
        },
        {
          title: `Prizes`,
          content: `Game.TV may provide prizes to users as determined in the promotion rules. The promotion
        ...
        {
          content: `ALL POTENTIAL WINNERS ARE SUBJECT TO VERIFICATION BY GAME.TV. GAME.TV’S
          ...
          WINNERS IS FINAL AND BINDING AND NOT SUBJECT TO CHALLENGE OR APPEAL.`,
          extraContentClass: `mb-24`,
        },
      ],
    },
    {
      title: `What are my rights in Game.TV?`,
      steps: [
        {
          content: `The materials displayed or performed or available on or through the Services, including, but not
          limited to, text, graphics, data, articles, photos, images, illustrations, User Submissions, and so
          forth (all of the foregoing, the “Content”) are protected by copyright and/or other intellectual
        ...
        {
          content: `You understand that Game.TV owns the Services. You won’t modify, publish, transmit,
        ...
        {
          content: `The Services may allow you to copy or download certain Content; please remember that just
    ...
    {
      title: `Do I have to grant any licenses to Company or to other users?`,
      steps: [
        {
          content: `Anything you post, upload, share, store, or otherwise provide through the Services is your “User
          Submission.” Some User Submissions are viewable by other users. In order to display your
          User Submissions on the Services, and to allow other users to enjoy them (where applicable),
          you grant us certain rights in those User Submissions. Please note that all of the following
          licenses are subject to our Privacy Policy to the extent they relate to User Submissions that are
          also your personally-identifiable information.`,
        },
        {
          content: `For all User Submissions, you hereby grant Game.TV a license to translate, modify (for
        ...
        {
          content: `If you share a User Submission publicly on the Services and/or in a manner that more than just
          ...
          in that Public User Submission in connection with the Services.`,
        },
        {
          content: `You agree that the licenses you grant are royalty-free, perpetual, sub-licenseable, irrevocable,
          ...
          remain viewable elsewhere to the extent that they were copied or stored by other users.`,
        },
        {
          content: `Finally, you understand and agree that Game.TV, in performing the required technical steps to
    ...
    {
      title: `What if I see something on the Services that infringes my copyright?`,
      steps: [
        {
          content: `You may have heard of the Digital Millennium Copyright Act (the “DMCA”), as it relates to online
          ...
          potentially infringing content, click <a href="/${language}/terms-and-privacy">here</a>. To learn more about the DMCA, click <a href="https://www.copyright.gov/legislation/dmca.pdf" target="_blank">here</a>.`,
        },
      ],
    },
    {
      ...
      steps: [
        {
          content: `Any information or content publicly posted or privately transmitted through the Services is the
        ...
        {
          content: `You are responsible for all Content you contribute, in any manner, to the Services, and you
        ...
        {
          content: `The Services may contain links or connections to third party websites or services that are not
          ...
          and conditions and privacy policy of each third-party website or service that you visit or utilize.`,
        },
        {
          content: `Game.TV has no control over, and assumes no responsibility for, the content, accuracy, privacy
        ...
        {
          content: `Your interactions with organizations and/or individuals found on or through the Services are
        ...
        {
          content: `If there is a dispute between participants on this site, or between users and any third party, you
    ...
    {
      title: `Will Game.TV ever change the Services?`,
      steps: [
        {
          content: `We’re always trying to improve the Services, so they may change over time. We may suspend
    ...
    {
      title: `Does Game.TV cost anything?`,
      steps: [
        {
          content: `No, there is no cost to you for using the services of Game.TV`,
        },
      ],
    },
    {
      title: `What if I want to stop using Game.TV?`,
      steps: [
        {
          content: `You’re free to do that at any time, by contacting us at TOU@Game.TV; please refer to our <a href="/${language}/terms-and-privacy">Privacy Policy</a> as well as the licenses above, to understand how we treat information you
          provide to us after you have stopped using our Services.`,
        },
        {
          content: `Game.TV is also free to terminate (or suspend access to) your use of the Services or your
        ...
        {
          content: `Account termination may result in destruction of any Content associated with your account, so
          keep that in mind before you decide to terminate your account.`,
        },
        {
          content: `Provisions that, by their nature, should survive termination of these Terms shall survive
    ...
    },
    {
      ...
      steps: [
        {
          content: `<u><i>Warranty Disclaimer</i></u>. Neither Game.TV nor its licensors or suppliers makes any
          ...
          the Services are provided “AS IS” and without any warranty of any kind from Company or others
        ...
        {
          content: `Limitation of Liability</i></u>. TO THE FULLEST EXTENT ALLOWED BY APPLICABLE LAW, UNDER
          ...
          THE AMOUNTS PAID BY YOU TO COMPANY IN CONNECTION WITH THE SERVICES IN
        ...
        {
          content: `<u><i>Indemnity</i></u>. To the fullest extent allowed by applicable law, You agree to indemnify and hold
        ...
        {
          content: `<u><i>Assignment</i></u>. You may not assign, delegate or transfer these Terms or your rights or obligations
        ...
        {
          content: `<u><i>Choice of Law; Arbitration</i></u>. These Terms are governed by and will be construed under the laws
          of the State of California, without regard to the conflicts of laws provisions thereof. Any dispute
          arising from or relating to the subject matter of these Terms shall be finally settled in San
          Francisco County, California, in English, in accordance with the Streamlined Arbitration Rules
          ...
          located in, respectively, San Francisco County, California, or the Northern District of California.
          <strong>Any arbitration under these Terms will take place on an individual basis: class
              ...
              BY ENTERING INTO THESE TERMS, YOU AND COMPANY ARE EACH WAIVING THE
              RIGHT TO TRIAL BY JURY OR TO PARTICIPATE IN A CLASS ACTION.</strong>`,
        },
        {
          content: `<u><i>Miscellaneous</i></u>. You will be responsible for paying, withholding, filing, and reporting all taxes,
          duties, and other governmental assessments associated with your activity in connection with the
          Services, provided that the Company may, in its sole discretion, do any of the foregoing on your
          behalf or for itself as it sees fit. The failure of either you or us to exercise, in any way, any right
          herein shall not be deemed a waiver of any further rights hereunder. If any provision of these
          ...
          and enforceable. You and Game.TV agree that these Terms are the complete and exclusive
          statement of the mutual understanding between you and Game.TV, and that it supersedes and
          ...
          not an employee, agent, partner, or joint venture of Game.TV, and you do not have any
          authority of any kind to bind Game.TV in any respect whatsoever. You and Game.TV agree
