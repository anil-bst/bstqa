    ...
    blocks: [
      {
        ...
        stepsContent: [
          ...
          {
            stepItem:
              'Vous vous êtes inscrit avec succès au tournoi {{gameName}}.',
            imgUrl:
        ...
        stepsContent: [
          {
            // tslint:disable-next-line: quotemark
            stepItem:
              "Accédez à <a href='/user' class='click-here'>App Web</a>  et connectez-vous avec votre compte Discord ou Twitter",
            imgUrl:
          ...
          },
          {
            // tslint:disable-next-line: quotemark
            stepItem:
              "Sous l'onglet Calendrier des tournois, vous pouvez trouver la liste des tournois {{gameName}} à venir.",
            imgUrl:
