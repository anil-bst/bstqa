    ...
    blocks: [
      {
        ...
        stepsContent: [
          ...
          {
            stepItem: '{{gameName}} turnuvasına başarıyla kayıt oldunuz.',
            imgUrl:
      ...
      },
      {
        ...
        stepsContent: [
          ...
          {
            stepItem:
              'Turnuva Takvimi sekmesinin altında yaklaşmakta olan {{gameName}} turnuvalarının listesini bulabilirsiniz.',
            imgUrl:
